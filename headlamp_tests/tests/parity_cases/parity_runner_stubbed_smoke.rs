...
use crate::parity_support::runner_parity::{
    RunnerId, RunnerParityScenario, assert_runner_parity_tty_all_four, write_stubbed_runner_repo,
};

#[test]
fn parity_runner_stubbed_smoke_pass_all_four() {
    ...
    assert_runner_parity_tty_all_four(
        &repo,
        &headlamp_bin,
        "stubbed smoke pass all four",
        &[
            (RunnerId::Jest, &[]),
            (RunnerId::CargoTest, &[]),
