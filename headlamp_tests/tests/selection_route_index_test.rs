...
fn selection_route_index_extracts_basic_http_routes() {
    ...
    let index = headlamp::selection::route_index::get_route_index(&repo);
...
fn selection_route_index_is_deterministic_and_monotone_under_extra_files() {
    ...
    let index_before = headlamp::selection::route_index::get_route_index(&repo);
    ...
    let index_after = headlamp::selection::route_index::get_route_index(&repo);
