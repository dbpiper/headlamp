...
#[path = "parity_repo_e2e_support/touch_real_source.rs"]
mod parity_repo_e2e_support_touch;
use parity_repo_e2e_support_touch::touch_real_source_file_used_by_tests;
