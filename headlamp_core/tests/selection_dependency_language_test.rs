...
fn ts_js_import_extraction_finds_common_import_forms() {
    ...
    let specs = headlamp_core::selection::dependency_language::extract_import_specs(
...
fn ts_js_import_resolution_resolves_extensions_and_index() {
    ...
    let c = headlamp_core::selection::dependency_language::resolve_import_with_root(
        headlamp_core::selection::dependency_language::DependencyLanguageId::TsJs,
        &from,
        "./c",
        &repo,
    ...
    let b = headlamp_core::selection::dependency_language::resolve_import_with_root(
        headlamp_core::selection::dependency_language::DependencyLanguageId::TsJs,
        &from,
        "./b",
        &repo,
...
fn rust_import_extraction_finds_mod_decls() {
    ...
    let specs = headlamp_core::selection::dependency_language::extract_import_specs(
        headlamp_core::selection::dependency_language::DependencyLanguageId::Rust,
        &lib_rs,
    );
...
fn rust_import_resolution_resolves_mod_files() {
    ...
    let a = headlamp_core::selection::dependency_language::resolve_import_with_root(
        headlamp_core::selection::dependency_language::DependencyLanguageId::Rust,
        &from,
        "a",
        &repo,
...
fn transitive_seed_refine_respects_language_specific_seed_terms() {
    ...
    let kept_tsjs =
        headlamp_core::selection::transitive_seed_refine::filter_tests_by_transitive_seed(
            &repo,
            headlamp_core::selection::dependency_language::DependencyLanguageId::TsJs,
            std::slice::from_ref(&test_abs),
            std::slice::from_ref(&seed_abs),
            headlamp_core::selection::transitive_seed_refine::MaxDepth(0),
        );
...
fn related_tests_rust_finds_integration_test_importing_crate_by_name() {
    ...
    let extracted = headlamp_core::selection::dependency_language::extract_import_specs(
        headlamp_core::selection::dependency_language::DependencyLanguageId::Rust,
        &repo.join("tests/a_test.rs"),
    );
    assert!(extracted.iter().any(|s| s == "demo_pkg::a"));

    let resolved = headlamp_core::selection::dependency_language::resolve_import_with_root(
        headlamp_core::selection::dependency_language::DependencyLanguageId::Rust,
        &repo.join("tests/a_test.rs"),
        "demo_pkg::a",
        &repo,
