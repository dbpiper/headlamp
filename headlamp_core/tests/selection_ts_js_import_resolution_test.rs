...
fn ts_js_resolution_relative_prefers_ts_over_js_and_supports_index() {
    ...
    let foo = headlamp_core::selection::dependency_language::resolve_import_with_root(
    ...
    let bar = headlamp_core::selection::dependency_language::resolve_import_with_root(
        headlamp_core::selection::dependency_language::DependencyLanguageId::TsJs,
        &from,
        "./bar",
        &repo,
